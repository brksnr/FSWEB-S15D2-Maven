...
public class StringSet {
    ...
    public static Set<String> findUniqueWords(){
        ...
        String[] metinler = metin.toLowerCase().replaceAll("[^a-zA-Z\\s]", "").split("\\s+");
        System.out.println(metinler.length);
        TreeSet<String> uniqueWords = new TreeSet<>(Arrays.asList(metinler));
